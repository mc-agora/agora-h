# Generated by Django 2.2.2 on 2019-06-26 11:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_pa', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('file', models.FileField(null=True, upload_to='documents/%Y/%m/%d')),
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_pa2', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('file', models.FileField(null=True, upload_to='documents/%Y/%m/%d')),
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_par', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('file', models.FileField(null=True, upload_to='documents/%Y/%m/%d')),
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_par2', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('file', models.FileField(null=True, upload_to='documents/%Y/%m/%d')),
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_pg', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('file', models.FileField(null=True, upload_to='documents/%Y/%m/%d')),
                ('like_users', models.ManyToManyField(blank=True, related_name='like_boards_pg2', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like3_users', models.ManyToManyField(blank=True, related_name='like3_parsed_data', to=settings.AUTH_USER_MODEL)),
                ('unlike3_users', models.ManyToManyField(blank=True, related_name='unlike3_parsed_data', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='RawData',
            fields=[
                ...
                ('like_users', models.ManyToManyField(blank=True, related_name='like_parsed_data', to=settings.AUTH_USER_MODEL)),
                ('unlike_users', models.ManyToManyField(blank=True, related_name='unlike_parsed_data', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Pg_Comment2',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like2_users', models.ManyToManyField(blank=True, related_name='like2_parsed_data', to=settings.AUTH_USER_MODEL)),
                ('unlike2_users', models.ManyToManyField(blank=True, related_name='unlike2_parsed_data', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
